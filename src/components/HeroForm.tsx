...
import { FaLocationArrow } from "react-icons/fa";
    ...
    return (
        ...
        <div className=" flex flex-col gap-2 mt-2">
            <label htmlFor="pick-location">Pick Location <FaLocationArrow className="inline-block ml-1 text-blue-500" /></label>
        ...
        <div className=" flex flex-col gap-2">
            ...
            <input type="date" id="pick-up-date" className=" outline-none border-b w-full" />
        </div>
        {/* Drop off date & time */}
        <div className=" flex flex-col gap-2">
            <label htmlFor="return-date">Return Date</label>
            <input type="date" id="return-date" className=" outline-none border-b w-full" />
        </div>
        {/* Search button */}
